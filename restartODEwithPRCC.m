...
beta_LHS = LHS_Call([], parameters.Control.beta, [], parameters.Control.beta/4, runs, 'norm');
q_LHS = LHS_Call([], parameters.Control.q, [], parameters.Control.q/4, runs, 'norm');
controlTime_LHS = LHS_Call(1, [], parameters.FinalTime, [] ,runs,'unif');
